...
int?id;
   Contract({super.key, required this.tenantname, this.id,required this.tenanphone, required this.tenantcard, required this.tenantadress, required this.tenantjob, required this.tenantnationality, required this.ownername, required this.ownerphone, required this.ownercard, required this.owneradress, required this.ownerjob, required this.ownernationality, required this.aqaradress, required this.aqaradressdetails, required this.aqarmohafza, required this.aqartype, required this.area, required this.emaranumber, required this.housenumber, required this.totalvalue, required this.insuranceval, required this.commessionvalue, required this.periodofdelay});
  @override
...
class ContractState extends State<Contract> {
 ...
 return LayoutBuilder(builder: (context, consters) {
      if (consters.maxWidth > 950)
        ...
        tenanphone:widget. tenanphone, tenantcard: widget.tenantcard, tenantadress:widget. tenantadress,
         tenantjob:widget. tenantjob, tenantnationality: widget.tenantnationality, ownername:widget. ownername,
          ownerphone:widget. ownerphone, ownercard:widget. ownercard, owneradress:widget. owneradress,
           ownerjob:widget. ownerjob, ownernationality:widget. ownernationality, aqaradress:widget. aqaradress,
            aqaradressdetails:widget. aqaradressdetails, aqarmohafza:widget. aqarmohafza, aqartype:widget. aqartype,
             area:widget. area, emaranumber:widget. emaranumber, housenumber:widget. housenumber, totalvalue:widget. totalvalue,
              insuranceval: widget.insuranceval, commessionvalue: widget.commessionvalue, periodofdelay:widget. periodofdelay);
