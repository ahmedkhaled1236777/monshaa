...
class alertcontent extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<addaqarcuibt, addaqarstate>(
                          ...
                          children: [
                           ...
                           custommaterialbutton(
                                  ...
                                  onPressed: () {
                                    ...
                                    BlocProvider.of<ShowaqaratCubit>(context) .queryParameters=  {
                                            "real_state_address": adress.text,
                                            "department":
                                                BlocProvider.of<addaqarcuibt>(
                                                        context)
                                                    .departement,
                                            "advertised_phone_number":
                                                phone.text,
                                            "lowest_price":pricefrom.text.isEmpty?null: num.parse(pricefrom.text),
                                            "highest_price": priceto.text.isEmpty?null: num.parse(priceto.text),
