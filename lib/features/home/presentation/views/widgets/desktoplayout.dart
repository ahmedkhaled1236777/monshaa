  ...
  Widget build(BuildContext context) {
   ...
   Directionality(
          ...
          child: Scaffold(
            ...
            appBar: AppBar(
              title: appbartittle(sizedboxwidth:  Appsizes.size5.w,logo: "images/logo.png", name: "شركة الاتقان",fontSize:5.sp ,),
              leading:const Text(''),
              leadingWidth: 0,
              titleSpacing: 10,
            ...
            body: ListView(
              ...
              children: [
                Container(
                  ...
                  child: ListView(
                    children:BlocProvider.of<HomeCubit>(context).drawer.map((e) => Column(
                      children: [
                        customdraweritem(sizedboxwidth: 3.w,textstyle: Appstyles.textStyle13w,iconsize: 6.w,iconData: e["icon"], text: e["name"], onTap: (){
                  ...
                  child: Container(
                    ...
                    child: GridView(
                      gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                          ...
                          mainAxisSpacing: 5.w),
                      children: BlocProvider.of<HomeCubit>(context).grid.map((e) => customgriditem(imagewidth: 12.w,textfontsize:3.6.sp ,image: e["image"], onTap: (){
                        navigateto(navigationscreen: e["page"], context: context);
