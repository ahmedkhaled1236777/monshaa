...
class ContractReports extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return ContractReportsState();
  }
}

class ContractReportsState extends State<ContractReports> {
